...
**Why this is a first-class PILOT-03 target:** the GCC donor base contains a very large South/Southeast Asian expatriate component, and **[CORRECTED 2026-09-11, D041/D043] DEL has been reported in the Gulf: Al Lawati 2021 (DOI 10.24377/LJMU.T.00014274) resolved a DEL allele (IVS8-31T>C) in 203 D-negative Omani samples. The earlier statement that no GCC study screened for DEL was REFUTED by the Stage 1 gate. What remains is that no *Saudi* donor DEL data were retrieved, and that a donor-pool DEL frequency is unachievable at feasible n (D039).** The C+ enrichment strategy from the Thai data makes DEL screening cheap to bolt on. `[INFERENCE]` `[RECOMMENDATION]`
