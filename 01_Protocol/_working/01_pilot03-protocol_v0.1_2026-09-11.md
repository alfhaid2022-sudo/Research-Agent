...
Transfusion-dependent patients with sickle cell disease (SCD) and β-thalassaemia in the Gulf region continue to form clinically significant red cell alloantibodies despite prophylactic serological Rh and K matching. In a Jazan multi-centre series of 1,027 transfusion-dependent patients (906 SCD, 121 thalassaemia) receiving Rh- and K-matched units, alloimmunisation was reported in 78/1,027 (7.6%), with anti-E (25.9%) and anti-K (24.1%) the commonest of 108 alloantibodies `[EVIDENCE — Meshi 2024, DOI 10.2147/IJGM.S444949]`. An earlier Jazan series of 438 transfusion-dependent patients (385 SCD; 53 thalassaemia, comprising 52 β- and 1 α-thalassaemia) at Prince Mohammed bin Nasser Hospital reported alloimmunisation rates of **12.98% in SCD and 13.21% in thalassaemia**, with anti-E and anti-K the commonest specificities `[EVIDENCE — Halawani 2022, PMID 35450032, DOI 10.2147/IJGM.S360320; PMC9017690 full text read 2026-09-11]`.
...
>
> **Residual ambiguity, unresolved by either reading `[UNCERTAIN]`:** the reported autoimmunisation rates imply ~2 SCD and ~2 thalassaemia autoimmunised patients, yet 50 + 7 already exhausts the 57 positive screens. Whether autoimmunised patients overlap the alloimmunised group is not stated.
>
