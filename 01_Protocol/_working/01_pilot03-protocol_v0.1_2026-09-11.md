...
> **Numerator correction (audit finding, `CLAUDE.md` §1.3).** An earlier draft of this protocol stated "50/385 SCD and 7/53 thalassaemia" as `[EVIDENCE]`. **Those numerators were back-calculated from the percentages and are not reported by the source.** The paper's Discussion states that "56 antibodies were detected in **50 immunized patients**" — 50 is a **combined total across both disease groups**, not an SCD numerator. Per-group numerators are therefore **`NR`** and may not be used or re-derived.
>
> **The source is also internally inconsistent `[UNCERTAIN]`**, and this is recorded rather than resolved: the Results state 57 patients had positive antibody screening, whereas the stated group rates imply 57 alloimmunised *plus* 4 autoimmunised (61); and the commonest-antibody frequencies differ between the Abstract (anti-E 17.19%, anti-K 14.06%), the Results (anti-E 19.64%, anti-K 14.28%, SCD only) and the Discussion (anti-E 17.9%, anti-K 14.06%). **No count derived from this source may enter any PILOT-03 output.** Only the two published rates may be cited, and only as rates.
