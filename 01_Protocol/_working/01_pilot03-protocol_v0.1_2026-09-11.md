...
Transfusion-dependent patients with sickle cell disease (SCD) and β-thalassaemia in the Gulf region continue to form clinically significant red cell alloantibodies despite prophylactic serological Rh and K matching. In a Jazan multi-centre series of 1,027 transfusion-dependent patients (906 SCD, 121 thalassaemia) receiving Rh- and K-matched units, alloimmunisation was reported in 78/1,027 (7.6%), with anti-E (25.9%) and anti-K (24.1%) the commonest of 108 alloantibodies `[EVIDENCE — Meshi 2024, PMID 38947563, DOI 10.2147/IJGM.S444949]`. An earlier Jazan series of 438 transfusion-dependent patients (385 SCD; 53 thalassaemia, comprising 52 β- and 1 α-thalassaemia) at Prince Mohammed bin Nasser Hospital reported alloimmunisation rates of **12.98% in SCD and 13.21% in thalassaemia**, with anti-E and anti-K the commonest specificities `[EVIDENCE — Halawani 2022, PMID 35450032, DOI 10.2147/IJGM.S360320; PMC9017690 full text read 2026-09-11]`.

> **Numerator provenance — corrected twice, `CLAUDE.md` §1.3.** An early draft stated "50/385 SCD (12.98%)" and "7/53 thalassaemia (13.21%)" as `[EVIDENCE]`. A first correction then asserted that "50 is a combined total across both disease groups." **That first correction was itself wrong** and is retracted here; the citation verification caught it.
>
> **What the source actually supports.** Halawani 2022 reports **rates, not numerators**. But its own figures reconcile on two independent lines: 12.98% × 385 = 49.97 and 13.21% × 53 = 7.00, summing to **57**, which matches the stated "57 patients had positive antibody screening"; and independently, anti-E *n* = 11 at 19.64% implies 56 antibodies in the SCD group, at 17.19% implies 64 overall, with the thalassaemia group's 2-antibody 25% implying 8 — and 56 + 8 = 64. The Discussion's "56 antibodies were detected in 50 immunized patients" therefore describes the **SCD group**, so **50 is the SCD numerator**, not a combined total.
>
> **Status: `[DERIVED]`, not `[EVIDENCE]`.** The numerators are arithmetically consistent and reproducible from the source, but **the paper never states them**. They are flagged as derived here, with the derivation shown, as §1.3 requires — and may be used only with that flag attached.
>
> **Residual ambiguity, unresolved by either reading `[UNCERTAIN]`:** the reported autoimmunisation rates imply approximately 2 SCD and 2 thalassaemia autoimmunised patients `[INFERENCE — this protocol's arithmetic, not stated by the source]`, yet 50 + 7 already exhausts the 57 positive screens. Whether autoimmunised patients overlap the alloimmunised group is not stated.
>
> **One earlier claim by this protocol was also overstated and is withdrawn:** that the source gives "three different anti-E frequencies." 17.19% (11/64, all patients) and 19.64% (11/56, SCD only) are different **denominators**, not a discrepancy. Only 17.19% versus the Discussion's 17.9% is a genuine internal inconsistency, and it is minor.
...
|---|---|---|---|---|---|
| Ameen 2020, PMID 32527616, DOI 10.1016/j.transci.2020.102748 | Kuwait | 917 | SNP DNA array | Multi-system; weak D 1/2/3 reported "not prevalent" (**numerator `[UNVERIFIED]` — no PMC record and publisher egress-blocked, so the full text could not be read; absence of a numerator is not established** — recorded `NR`) | No |
| Al-Riyami 2021, PMID 34647328, DOI 10.1111/vox.13204 | Oman | 180 genotyped (130 paired with serology) | RBC-FluoGene vERYfy eXtend | 12-system screen; "D variant 18.2% (22/121)" not resolved to allele in the abstract | Bare per-system percentages only; **not described in the abstract** — no taxonomy, CI or adjudication algorithm appears there. `[UNVERIFIED]` The full text has no PMC record and Wiley is egress-blocked, so this is a statement about the abstract only, **not** about the study. The gate log records 14/112 Fy^b^ discrepancies that *were* adjudicated |
...
| Madkhali 2025, PMID 41147787, DOI 10.1111/tme.70040 | Saudi Arabia (Jazan) | 60 (*RHD*, D−/weak D only); 464 (*RHCE*) | ID RHD XT / ID CORE XT (Luminex) | *RHCE* dataset with the largest genotyped n among retrieved GCC studies `[no superlative claimed; see §1.4]` — deepest *RHCE* dataset in the region | No — antigen frequencies are platform-**predicted**, not serologically observed |
| Haffener 2025, PMID 40916454, DOI 10.1111/trf.18401 | Oman | 100 | Whole-genome sequencing vs serology, 24 antigens | Rh prediction 100% by copy-number + *RHD*Ψ; **no partial-D resolution, no DEL** `[EVIDENCE — PMC12531907 full text, read by Integrity Auditor 2026-09-11]` | **Yes — 98.7% accuracy; 98.7% accuracy; 12 discordances investigated — **candidate variants proposed for 4, a genotyping error identified in 1, and 7 (all MNS) left unresolved** `[EVIDENCE — PMC12531907]`. That 58% non-resolution rate is a directly relevant feasibility datum for this protocol's own adjudication workflow.** Single centre (SQUH blood bank), randomly selected consented donors |
| Al Lawati 2021, DOI 10.24377/LJMU.T.00014274 (LJMU doctoral thesis; **no PMID, grey literature, abstract-level only**) | Oman | 203 serologic D− samples — the source says "dry blood samples … from Omani cohort" and **does not describe them as donors** `[UNCERTAIN]`; the count of six datasets depends on this row | Molecular *RHD* characterisation | Weak D types 45, 41, 4.2, DAR2.00, DIIIb, DVI.2; **includes a DEL allele (IVS8-31T>C)** | Not reported |
...
| "None reports serology–genotype concordance as a pre-specified outcome with a discordance classification" | **REFUTED** | PMID 40916454 — 12 discordances investigated (candidate variants proposed for **4**, genotyping error in **1**, **7 MNS unresolved**) |
| "No GCC study has genotyped serologically D-positive donors for partial D" | **UNVERIFIABLE — not assertable.** Alalshaikh genotyped 70 D-positive donors but for exon presence/zygosity only. **Correction 2026-09-11:** an earlier version of this row said Haffener's *RHD* results were "behind egress blocks" — **that was false.** PMC12531907 was retrieved in full on two independent occasions (Integrity Auditor; Citation Verification) and shows Rh predicted by copy-number plus *RHD*Ψ with **no partial-D resolution**. The Haffener limb is therefore closed. **Only Ameen 2020 remains unread** (no PMC record; publisher egress-blocked), so this proposition rests on a single unknown | PMID 39055072; PMID 32527616 |
...
3. **Platform harmonisation as a methodological rationale, not a novelty claim.** Retrieved GCC studies each used a different platform (SNP array / melting-curve PCR-SSP / multiplex PCR / Luminex bead assay / WGS); platform-versus-platform discordance is documented — 7 *RHD* and 6 *RHCE* alleles discordant between manual and automated methods `[EVIDENCE — Vege S, Westhoff CM, 2011. In: *BeadChip Molecular Immunohematology*. Springer, New York. DOI 10.1007/978-1-4419-7512-6_11; **pages `[UNVERIFIED — registry blocked]`**. Note: the 7/6 discordance counts are exact, but derive from **149 *RHD* and 168 *RHCE* problem referrals** — an enriched referral panel from the 2011 BeadChip era, so the *rate* is not transferable to an unselected donor population]` — so frequencies across those studies cannot be pooled without confounding by assay.
...
A DEL donor types D-negative on routine serology, so the unit is labelled D-negative and issued to a D-negative recipient, yet can immunise: primary anti-D in a D-negative Korean recipient was traced to a DEL donor carrying *RHD*(c.1227G>A) `[EVIDENCE — Kim 2009, PMID 19726900, DOI 10.3343/kjlm.2009.29.4.361]`. Partial D in a normally-reacting D+ donor or patient is the configuration that matters most on the recipient side: two Saudi obstetric patients typing D+ on routine serology carried *RHD\*DAU2*/*DAU6* and weak D type 4.1, and neither received RhIG `[EVIDENCE — Owaidah 2023, PMID 36883669, DOI 10.23750/abm.v94iS1.14120]`. **This motivation stands regardless of how much of §1.3.2 survives future searching**, and is the reason the study is worth doing even if its novelty narrows further.
...
**Tier 1 must be one platform, one vendor, one assay version, across all centres.** Where centres cannot run the same platform locally, **all genotyping is centralised in a single reference laboratory** and local centres contribute samples and serology only. A multi-platform Tier 1 is prohibited: it would manufacture class-D7 discordance and confound every between-centre comparison `[EVIDENCE — Vege S, Westhoff CM, 2011. In: *BeadChip Molecular Immunohematology*. Springer, New York. DOI 10.1007/978-1-4419-7512-6_11; **pages `[UNVERIFIED — registry blocked]`**. Note: the 7/6 discordance counts are exact, but derive from **149 *RHD* and 168 *RHCE* problem referrals** — an enriched referral panel from the 2011 BeadChip era, so the *rate* is not transferable to an unselected donor population]` `[INFERENCE]`.
...
1. **Anti-D clone panel, not a single reagent.** For every D test, record: **clone identity, manufacturer, lot number, immunoglobulin class (IgM/IgG/blend), and method**. Without clone identity a class-D3 or D4 discordance is uninterpretable, because monoclonal anti-D clones differ in their reactivity with partial and weak D `[EVIDENCE — Srivastava 2022, DOI 10.21307/immunohematology-2022-036; Rodrigues 2021, PMID 33867285, DOI 10.1016/j.transci.2021.103135]`. A minimum of **two anti-D clones of differing specificity profile** is required for the D determination. `[UNVERIFIED]` — which clones are available at each centre is a site-survey item. `[Rodrigues 2021, PMID 33867285: co-citation marked **[UNVERIFIED — full text needed]**. Its abstract states only that anti-D clones were compared; it reports no clone-level result, and no PMC record exists (publisher egress-blocked). This claim rests on Srivastava 2022, PMID 35852060, which was verified from full text. Rodrigues is also typed by PubMed as `Clinical Trial` — an indexing artefact for an observational donor study; it must not be described as a trial.]`
...
3. **Weak D testing is performed on every direct-phase D-negative donor**, by a single specified method across all centres. The serological method itself may move the discordance rate: the cited source reports that high-sensitivity confirmatory testing **"can reduce"** the frequency of weak D typed as D-negative, inferred from finding no weak D type in either screening population — it did **not** measure a reduction `[EVIDENCE, modality preserved — de Paula Vendrame 2019, PMID 31587310]`. Adding a high-sensitivity solid-phase confir test reduced the frequency of weak D samples typed as D-negative `[EVIDENCE — de Paula Vendrame 2019, PMID 31587310, DOI 10.1111/vox.12851]`. Mixing methods across centres would therefore create artefactual between-centre differences.
4. **Adsorption–elution is NOT performed routinely.** DEL is therefore a **genotype-only finding** in this study, and the protocol states this explicitly rather than implying serological confirmation. `[EVIDENCE — Kim 2009, PMID 19726900 defines DEL as serologically detectable only by adsorption–elution]` If adsorption–elution is performed on a defined subset, that subset and its trigger must be pre-specified as an amendment before any DEL result is known.
...
| `nationality_stratum` | National of a GCC state vs expatriate | Categorical | National / expatriate / not recorded | Donor record **`[Evidence asymmetry, audit P6]` The African-ancestry limb is well supported by Madkhali 2025. The East/Southeast Asian limb is NOT: that paper's non-Saudi group contained only 2 of 110 East/SE Asian donors (Nepal 1, Philippines 1), which cannot support a repertoire claim. The Asian limb is `[HYPOTHESIS]` and is retained only as a stratification rationale, not as evidence of a distinct repertoire.** |
...
| `antiD_clone_*`, `sero_method` | **Measurement-bias variable for the concordance outcome** | Clone reactivity and method sensitivity both vary in their reactivity with partial and weak D `[EVIDENCE — Srivastava 2022, PMID 35852060, n=1 case; reports no rate, so no claim about moving a rate is made]` `[EVIDENCE — de Paula Vendrame 2019, PMID 31587310; Srivastava 2022]`. This is why they are dataset variables (D025 item 3). |
...
- **"Serologic D-negative" and "molecularly *RHD*-negative" are distinct terms and are never used interchangeably** `[EVIDENCE — Flegel 2025, PMID 40537781, DOI 10.1186/s12967-025-06716-8]`.
...
| R6 | **Serological method heterogeneity across centres** | Between-centre "differences" that are reagent artefacts; discordance rate potentially driven by method (the source says high-sensitivity testing **"can reduce"** misclassification; it did not measure a reduction) `[EVIDENCE — de Paula Vendrame 2019, PMID 31587310]` | §7.3 harmonised SOP; clone/lot/method as per-test variables; centre-stratified sensitivity analysis (§12.5) | Moderate — full harmonisation may be impractical; the variables at least make it analysable rather than invisible. |
